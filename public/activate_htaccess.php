...
$wellKnownFiles = ['ai-catalog.json', 'webmcp.json', 'mcp.json', 'ai-plugin.json', 'api-catalog', 'http-message-signatures-directory', 'agent-card.json', 'agent-skills/index.json', 'auth.md', 'sovp-identity.json', 'identity.json', 'oauth-protected-resource', 'oauth-protected-resource.json', 'oauth-authorization-server', 'oauth-authorization-server.json', 'openid-configuration', 'openid-configuration.json', 'ai.txt', 'mcp/server-card.json'];
