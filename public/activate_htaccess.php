...
$wellKnownFiles = ['webmcp.json', 'mcp.json', 'ai-plugin.json', 'api-catalog', 'http-message-signatures-directory', 'agent-card.json', 'agent-skills/index.json', 'auth.md', 'sovp-identity.json'];
