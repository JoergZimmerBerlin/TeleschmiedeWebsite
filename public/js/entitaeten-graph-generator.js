...
- 'areaServed': Bediente Region (z. B. Stadt, Land, "DACH" oder "World")
...
- 'subjectOf': Verifizierte Drittquellen, Fachartikel, Presseberichte, Interviews oder Podcasts (CreativeWork / NewsArticle mit 'headline', 'url' und 'publisher')
...
- 'sameAs': Alle verifizierten externen Unternehmens- und Registerprofile (Handelsregister / North Data / Bundesanzeiger, LinkedIn Company, Crunchbase, Xing, YouTube, Google Knowledge Panel, etc.)
...
- '${url}#organization' (Hauptorganisation mit vollem Core-Katalog, Gründung, Adresse, Steuernummern, ISO-Zertifikate, Mitgliedschaften)
- '${url}#website' (WebSite mit 'publisher': {'@id': '${url}#organization'}, 'potentialAction' (SearchAction) und 'inLanguage')
...
- '${url}#person-[slug]' (Für JEDE ermittelte Schlüsselperson mit vollem E-E-A-T Person-Katalog, Alumni und sameAs)
- '${url}#offer-catalog' (Angebotskatalog mit den 3 bis 5 wichtigsten Services/Products)
