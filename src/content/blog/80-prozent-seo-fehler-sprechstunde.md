...
key_takeaways:
  ...
  - "Wer seine Hausaufgaben bei technischer Hygiene und Core Web Vitals macht, erzielt mit 20 Prozent Aufwand 80 Prozent des maximalen Hebel-Ertrags."
faqs:
  - question: "Warum scheitern so viele professionelle Websites an simplen Basics?"
    answer: "Weil SEO im Projektalltag häufig als nachgelagerte Pflichtübung verstanden wird, anstatt von der ersten Konzeptionsminute an mit am Tisch zu sitzen. Viele Agenturen investieren ihr gesamtes Budget in visuelle Effekte und Animationen, vergessen dabei jedoch die elementare Straßenkarte für Google-Crawler. Wenn die technische Hygiene fehlt, nützt das schönste Frontend nichts."
  - question: "Ist die Live-Analyse in der Sprechstunde auch für Profis sinnvoll?"
    answer: "Unbedingt. Gerade erfahrene Inhouse-Teams entwickeln im Alltag eine spürbare Betriebsblindheit für die eigene Domain. In der Sprechstunde decken wir im gemeinsamen Screen-Sharing ohne Vorbehalte genau jene Fehler auf, die im Tagesgeschäft jahrelang übersehen wurden. Häufig identifizieren wir in zwei Stunden mehr konkrete Hebel als in monatelangen internen Meetings."
  - question: "Welcher handwerkliche Fehler vernichtet die meisten Rankings?"
    answer: "Mit großem Abstand: Relaunches ohne lückenloses 301-Redirect-Mapping. Wer alte Adressen bei einem Designwechsel unbedacht löscht oder ins Leere laufen lässt, vernichtet in wenigen Stunden jahrelang erarbeitete Domain-Autorität und Linkpower. Das ist digitaler Selbstmord auf Raten und leider traurige Praxis."
  - question: "Lohnt sich die Buchung einer fokussierten Live-Diagnose?"
    answer: "Wenn man bedenkt, dass ein einziger technischer Fehler wie ein aktiver Noindex-Befehl den kompletten organischen Neukundenkanal lahmlegen kann, ist eine zweistündige Experten-Prüfung die rentabelste Versicherung für dein gesamtes digitales Geschäftsmodell."
---
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Vor 10 Jahren. Diese die Basics, die haben sich ja kaum kaum geändert. Ja, die die das werden immer noch die gleichen Fehler gemacht wie früher komischerweise. Ähm und dann kann man das ruhig mal recyceln und mal mit ein bisschen äh ja, aber dass ich jetzt selber, dass ich das, was ich die Energie, die ich in LinkedIn investiere,.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=1381s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (23:01)</span>
