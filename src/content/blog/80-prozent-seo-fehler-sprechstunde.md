...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Design verkauft vielleicht beim ersten Eindruck. Aber saubere Technik und exzellente Ladezeiten behalten den Kunden. Wer grundlegende Web-Basics ignoriert, verbrennt Marketing-Budgets schneller, als Google den Crawling-Fehler protokolliert.“
  </blockquote>
