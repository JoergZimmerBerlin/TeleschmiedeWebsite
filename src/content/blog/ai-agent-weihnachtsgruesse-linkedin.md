...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Authentizität lässt sich nicht automatisieren. Wer glaubt, geschäftliches Vertrauen per Prompt-Engineering aufzubauen, hat das Prinzip Social Media nicht verstanden. In einer Welt voller synthetischer Bots ist das Unperfekte das neue Premium.“
  </blockquote>
