...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Wer eine Website ohne verifizierte Search Console launcht, übergibt ein Auto ohne Armaturenbrett. Wer misst, führt das Projekt datengestützt zum Erfolg – wer nicht misst, hofft nur auf ein Wunder bei der Indexierung.“
  </blockquote>
