...
faqs:
  - question: "Was unterscheidet eine Agent-Ready Website von einer herkömmlichen Webpräsenz?"
    answer: "Traditionelle Websites optimieren primär für menschliche Augen und klassische Suchmaschinen-Spinnen. Eine Agent-Ready Website stellt zusätzlich maschinenlesbare Schnittstellen bereit: Sie liefert über llms.txt hochverdichtete Fakten im reinen Markdown-Format aus, nutzt Content Negotiation für Token-Ersparnis und verlinkt semantische Entitäten über vollständige Schema.org-Graphen."
  - question: "Welche konkrete Aufgabe erfüllt die Datei llms.txt?"
    answer: "Die llms.txt fungiert als kuratiertes Inhaltsverzeichnis für Large Language Models. Sie zeigt autonomen Crawlern und Agenten sofort, welche Kernaussagen, Leistungsangebote und Dokumentationen auf der Domain vorhanden sind, ohne dass das Modell Hunderte HTML-Dateien mit überflüssigem Markup parsen muss."
  - question: "Wozu benötigt man sogenannte Grounding Pages?"
    answer: "Grounding Pages sind komprimierte, zweisprachige Faktenübersichten, die als unmissverständliche 'Source of Truth' formuliert sind. Sie listen Unternehmensdaten, Kernkompetenzen, Zertifikate und Preismodelle so eindeutig auf, dass Sprachmodelle bei Anfragen nicht halluzinieren, sondern verlässliche Fakten zitieren."
  - question: "Bringen diese technischen Erweiterungen schon heute messbare Vorteile?"
    answer: "Ja, vor allem bei der Zitationsrate in Perplexity, Claude und ChatGPT Search. Agenten bevorzugen Webseiten, die Daten barrierefrei und tokenarm bereitstellen. Wer frühzeitig standardisierte Protokolle implementiert, sichert sich entscheidende Wettbewerbsvorteile im Generative Engine Optimization (GEO)."
---
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      ...
      <a href="https://www.linkedin.com/feed/update/urn:li:activity:7105500055561740288" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
...
![Architektur einer Agent-Ready KI-Website](../../assets/images/blog/ki-leuchtturm-architektur-3d.webp)
