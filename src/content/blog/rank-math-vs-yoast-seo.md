...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Yoast SEO hat großartige Pionierarbeit geleistet, ruht sich aber seit Jahren auf seiner Marktmacht aus. Wer heute für jede Selbstverständlichkeit – von Redirects bis zu lokalen Schemata – separate Zusatz-Plugins kaufen muss, verbrennt Budget und überlädt seine WordPress-Datenbank. Rank Math liefert die schlankere Architektur und das ehrlichere Lizenzmodell für die moderne Suche.“
  </blockquote>
