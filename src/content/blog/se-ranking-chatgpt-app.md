...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  💪 Website Audits<br>
  💪 KI Sichtbarkeit</p>
  <p>Alles per Chat erfragen und Pläne schmieden die zum Projekt passen. Auch zur Wettbewerbsanalyse.</p>
  </div>
</div>
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  <div class="italic text-dark mb-0">
    <p>wenn die KI auch die eigenen Live-Daten miteinbeziehen kann wird es richtig spannend – guter Workflow 👍</p>
  </div>
</div>
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  <div class="italic text-dark mb-0">
    <p>Danke dir für den Tipp Jörg - das probiere ich direkt mal aus 🙏😊🚀</p>
  </div>
</div>
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  <div class="italic text-dark mb-0">
    <p>Bist du wirklich so ein großer Fan von SE Ranking oder ist die Affiliate-Provision bei denen so gut? 😇 Nein, Spaß bei Seite. Ich bin auch dabei, zu SE Ranking zu wechseln, bin aber noch nicht 100%ig überzeugt. Vielleicht überzeugst du mich ja noch.</p>
  </div>
</div>
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Haufen Arbeit und dann kam aber diese diese gelben Scheine, die man Krankmeldung nennt. Äh war wahrscheinlich damals von ihm auch eine persönliche Geschichte, wo er musste sich da glaube ich um seine auch seine um seine Kinder kümmern und und ich weiß auch nicht. Auf jeden Fall plötzlich, wenn du dann da sitzt, du hast doppelt so viel Arbeit und sitzt einen Monat.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=dVGOMAVUNQk&t=1503s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube SEOPresso (25:03)</span>
