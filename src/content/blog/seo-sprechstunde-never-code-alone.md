...
key_takeaways:
  ...
  - "Vibe Coding als Zukunft: Wenn du neue, innovative Themen besetzt, musst du frühzeitig die passenden Cluster in deiner Website-Struktur aufbauen, um nicht als reines Lexikon abgestraft zu werden."
faqs:
  - question: "Was ist der genaue Unterschied zwischen SEO und GEO?"
    answer: "Generative Engine Optimization (GEO) konzentriert sich darauf, Inhalte so aufzubereiten, dass KI-Modelle wie ChatGPT oder Claude diese Fakten extrem schnell extrahieren und in ihre Antworten (RAG) integrieren können. Klassisches SEO hingegen ist immer noch primär für den menschlichen Nutzer gemacht – mit Design, Struktur und Conversion-Pfaden. Ohne die klassischen SEO-Grundlagen (Kruste und Garraum) wird dich jedoch auch kein KI-Crawler ernst nehmen."
  - question: "Warum ist Info-Traffic oft ein Problem für B2B-Websites?"
    answer: "Wenn eine Website massiv auf informationelle Suchwörter optimiert ist (z.B. Erklärungen zu 'iPhone' oder 'Hugging Face'), stuft Google die Domain primär als 'Wikipedia-Klon' oder Lexikon ein. Das verwässert den eigentlichen transaktionalen Fokus. Wenn du dann plötzlich hochpreisige B2B-Schulungen oder Vibe-Coding-Consulting verkaufen willst, fehlt dir in den Augen von Google die harte Relevanz in genau diesem spezifischen Cluster."
  - question: "Was bringt mir eine 120-minütige SEO-Sprechstunde wirklich?"
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Krauler, dass die alle deine Informationen super aufbereitet finden. Da haben die Leute noch extrem viel äh Bedarf und Potenzial auch. Ja. Und dann um den Sprung zu machen, bitte geh auch zu den anderen, geh auch zu Google Maps, trag dein Business dort ein, optimier das Profil der Mann, das ist kostenlos.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=32YkPQtOJDU&t=1573s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Magic Writing Podcast (26:13)</span>
