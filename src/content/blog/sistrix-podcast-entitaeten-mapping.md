...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Ein Knowledge Panel ist kein Eitelkeits-Pokal für das Ego, sondern die offizielle Bestätigung der Algorithmen, dass deine Marke als eigenständige Entität im semantischen Netz existiert. Wer diese Verknüpfung nicht aktiv steuert, überlässt seine Reputation den Halluzinationen der Sprachmodelle.“
  </blockquote>
