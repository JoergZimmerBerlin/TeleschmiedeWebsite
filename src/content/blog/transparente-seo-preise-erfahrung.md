...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Öffentliche Preise auf der Website sind der beste Filter der Welt. Sie beenden nervige Preisfeilscherei, sortieren Schnäppchenjäger sofort aus und bringen ausschließlich Anfragen von Entscheidern, die den echten Wert von 25 Jahren Praxiserfahrung schätzen.“
  </blockquote>
