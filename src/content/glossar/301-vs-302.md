...
title: '301 vs. 302 Redirects: Technischer Deep-Dive für Server und KI'
description: '301 vs. 302 Redirects auf Protokollebene erklärt. Warum der 301er dein Linkjuice-Retter ist und KI-Crawler einen 302er ablehnen. Tacheles zur Server-Architektur.'
date: "2026-03-19"
...
Der Googlebot und moderne KIs interpretieren das als Soft-404-Fehler. Eine gelöschte Seite über "Schraubenzieher" auf eine Startseite weiterzuleiten, ergibt keinen semantischen Sinn. Der Linkjuice verpufft komplett. Jede alte URI muss auf eine thematisch exakt passende, neue URI weitergeleitet werden.
...
Bei Apache-Servern steuerst du Redirects über das `mod_alias` oder `mod_rewrite` Modul.
