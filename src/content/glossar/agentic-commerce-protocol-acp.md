...
title: "Agentic Commerce Protocol: KIs kaufen für dich (2026)"
description: "Was das Agentic Commerce Protocol (ACP) bedeutet. Wie AI-Agenten mit Shops verhandeln und den Checkout revolutionieren. Klartext. (2026)"
date: "2026-07-22"
...
key_takeaways:
  - "Das ACP ist ein Standard für KI-Agenten, um als autonome Käufer in Onlineshops zu agieren und Zahlungen abzuwickeln."
  - "Es eliminiert manuelle Checkouts und macht aus Informations-KIs echte 'Action Engines', die reale Transaktionen ausführen."
  - "Der Händler behält die volle Kontrolle über Preise und Inventar, während Shared Payment Tokens für maximale Sicherheit sorgen."
faqs:
  - question: "Was genau ist das Agentic Commerce Protocol (ACP)?"
    answer: "Das ACP ist ein im Herbst 2025 von OpenAI und Stripe eingeführtes Open-Source-Protokoll, das die Kommunikation zwischen KI-Agenten und E-Commerce-Plattformen standardisiert. Es ermöglicht Agenten, für den Nutzer nicht nur Produkte zu finden, sondern den gesamten Kaufprozess inklusive sicherem Checkout völlig autonom abzuschließen. Die KI wird so vom reinen Chatbot zum aktiven Wirtschaftsakteur."
  - question: "Wie funktioniert die Bezahlung beim ACP?"
    answer: "Die Bezahlung läuft über hochsichere Shared Payment Tokens (SPTs). Der Nutzer hinterlegt seine Zahlungsdaten einmalig sicher, und der KI-Agent nutzt diese Tokens, um Transaktionen beim Händler zu autorisieren. Der Clou dabei ist, dass die eigentlichen Kreditkartendaten nie beim Agenten im Klartext landen und der Händler seine bestehende Zahlungsinfrastruktur einfach weiter nutzen kann."
  - question: "Verliert der Händler durch ACP die Kontrolle?"
    answer: "Absolut nicht. Eines der wichtigsten Designprinzipien des Agentic Commerce Protocols ist, dass der Shopbetreiber immer der 'Merchant of Record' bleibt. Das bedeutet, dass der Händler weiterhin die volle Kontrolle über Preisgestaltung, Inventarverwaltung, Steuern, Versandkosten und Betrugsprävention hat, während die KI lediglich die Schnittstelle zum Käufer bedient."
---
...
![3D Infografik zum Agentic Commerce Protocol (ACP) mit B2B-Verhandlungen und Auto-Checkout](../../assets/images/glossar/3d-light/glossar-agentic-commerce-protocol-acp-3d.webp)
