---
title: "AI Citation Analysis: Verlinkungen und Zitationen in KIs"
...
faqs:
  - question: "Was ist eine AI Citation Analysis?"
    answer: "Sie analysiert Muster und Häufigkeiten, mit denen Domains in KI-Antworten referenziert werden. Dabei wird unterschieden, ob eine echte Zitation (Quellen-Link) oder nur eine reine Referenz der Domain vorliegt."
  - question: "Was ist das 'Category Distribution' Feature?"
    answer: "Rankscale zeigt die Verteilung der Zitationskategorien an (z. B. ob Produktdetailseiten, redaktionelle Artikel oder Support-Dokumente zitiert werden) und wie sich dieser Trend im Monatsvergleich verschiebt."
  - question: "Wertet Rankscale auch das Sentiment um die Zitation aus?"
    answer: "Ja. Das System analysiert den 'Sentiment context', also die Tonalität der Aussagen, in die deine Marke oder deine Zitation eingebettet ist (positiv, neutral oder negativ)."
---
...
Um die KI-Sichtbarkeit einer Marke greifbar zu machen, bricht die Plattform das Tracking auf drei fundamentale "Citation Metrics" herunter. Diese Metriken bilden das Fundament, auf dem du deine [Generative Engine Optimization (GEO)](/glossar/geo-optimierung/) aufbaust.
...
- **Reine Referenz:** Das KI-Modell nennt lediglich deinen Domain-Namen ("laut XY"), setzt aber keinen direkten Link.
Nur wenn du weißt, wie du zitiert wirst, kannst du durch gezieltes [GEO Page Audit](/glossar/geo-page-audit/) daran arbeiten, aus reinen Referenzen echte, traffic-treibende Links zu machen.

### 3. Sentiment Context (Der Vibe der Zitation)
Selbst wenn du oft zitiert wirst, hilft es dir nicht, wenn die KI vor deinen Produkten warnt. Daher analysiert das System den "Sentiment Context". Es untersucht den Vibe und die Tonalität der generierten Antwort, in die deine Marke eingebettet wurde. Die Plattform kategorisiert das Sentiment in drei klare Abstufungen: positiv, neutral oder negativ. ([AI Sentiment Analysis](/glossar/ai-sentiment-analysis/))
...
<div class="my-8 bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose">
  ...
  <div class="bg-white/80 p-4 rounded-xl border border-lime-accent/30 text-xs text-neutral-800 space-y-2">
    <p class="font-bold text-dark mb-1">🔍 Dein 30-Sekunden-Check in Perplexity & ChatGPT (ohne Programmierkenntnisse):</p>
    <p class="mb-1">1. Gib deine primäre Transaktions-Frage in Perplexity oder ChatGPT mit aktiviertem Web-Search ein.</p>
    <p class="mb-1">2. Fahre mit der Maus über die verlinkten Zitations-Fußnoten: Führen diese auf deine Domain oder auf Vergleichsportale und Mitbewerber?</p>
    <p class="mb-0">3. <strong>Deine Kontrollfrage an die Webagentur:</strong> <em>„Überwachen wir systematisch unseren Citation Share gegenüber Wettbewerbern mit Tools wie Rankscale und optimieren wir gezielt nach dem Answer-First-Prinzip für RAG-Quellen?“</em></p>
  </div>
</div>
...
1. **Brand Share by Citation Mentions**
2. **Brand Share by Unique URLs**
3. **Brand Share by Unique Domains**
Durch diese dreifache Sicht ("across three views") erkennst du sofort, wo du den Markt anführst ("where you lead") und in welchen Metriken dich deine Wettbewerber outranken.

## Der Mention-Source Divide: Nennung vs. klickbare Zitation

Eines der zentralen Phänomene in der modernen [Generativen Suche (GEO)](/glossar/geo-optimierung/) ist der sogenannte **Mention-Source Divide**:
...
Kombiniert man die Citation Data mit einem umfassenden [AI Rank Tracker](/glossar/ai-rank-tracker/), erhält man eine lückenlose End-to-End Visibility über die gesamte AI Search Landschaft. Wie die renommierte SEO & Content Strategy Beraterin **Aneta Pawlik** treffend formuliert: *"Rankscale is the best tool I have found on the market."* 
