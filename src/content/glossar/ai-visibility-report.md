...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Äh kritisch. Ja, wenn ich eine Aufgabe kriege, wo ich denke, das macht jetzt gar nicht so den Sinn oder du produzierst ein Report, der zwar Kennzahlen enthält, aber nicht die Kennzahl, die dir eine Aussage liefern könnte, dann würde ich dann halt sagen, na ja, aber das macht ja sogar keinen Sinn und das will ein Chef meistens nicht hören. Ähm, als Berater darf ich.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=dVGOMAVUNQk&t=931s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube SEOPresso (15:31)</span>
...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md relative not-prose">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <p><strong>2. Defensive & konfliktfreie Integration:</strong> Binde API-Keys strikt über Umgebungsvariablen (.env) ein und füge .env zur .gitignore hinzu. Entwickle das Skript modular in einem separaten Tool-/Script-Pfad, ohne App-Routen zu stören. Beachte dabei: Schritte & Validierung:; Parse ein JSON-Array mit simulierten Prompt-Ergebnissen (Modell, Prompt, Antworttext, Zitationslinks); Berechne: Presence Rate (Erwähnung der Marke), Citation Rate (Link zur Domain vorhanden) und Competitive Share of Model.</p>
