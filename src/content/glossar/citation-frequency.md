---
title: "Was ist Citation Frequency in der AI SEO?"
meta_title: "Citation Frequency (AEO Metrik): Definition (2026)"
description: "Erfahre, was die Citation Frequency (Zitierhäufigkeit) in der Answer Engine Optimization bedeutet und wie sie deine KI-Sichtbarkeit bestimmt. (2026)"
meta_description: "Erfahre, was die Citation Frequency (Zitierhäufigkeit) in der Answer Engine Optimization bedeutet und wie sie deine KI-Sichtbarkeit bestimmt. (2026)"
date: "2026-08-21"
image: "/src/assets/images/glossar/3d-light/glossar-citation-frequency-3d.webp"
image_alt: "3D Illustration - Citation Frequency mit lime-grünen Zitatzeichen"
...
faqs:
  - question: "Was bedeutet Citation Frequency?"
    answer: "Die Citation Frequency (Zitierhäufigkeit) ist eine Kennzahl, die angibt, wie oft eine spezifische Marke oder Domain in generierten KI-Antworten über ein vordefiniertes Set an Zielgruppen-Prompts hinweg als Quelle (Citation) referenziert wird."
  - question: "Warum ist diese Metrik wichtiger als Rankings?"
    answer: "Weil die Zero-Click-Suche zunimmt. Nutzer erhalten Antworten direkt im Chat. Wenn du dort nicht als Citation auftauchst, existierst du im Rechercheprozess des Nutzers nicht – unabhängig davon, ob du bei Google auf Platz 1 stehst."
  - question: "Wie steigere ich meine Citation Frequency?"
    answer: "Durch Generative Engine Optimization (GEO). Strukturiere deine Inhalte mit dem BLUF-Prinzip (Bottom Line Up Front), verwende Zitate und harte Statistiken und biete der KI maschinenlesbaren Content (z. B. via llms.txt)."
---
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Aber angenommen, er würde mich da jetzt zitieren und dann kriege ich hier ein Haufen Anrufe, wo die Leute sagen, ich habe da eine Webseite, ich möchte mal gerne schönes Design und dann muss ich ja immer sagen, wie kommen Sie denn auf mich? Und dann sagt er, das hat mir mein AI Overview gesagt oder das hat mir mein Meta Chatbot gesagt. Und wie steuer ich denn dann gegen? Dann muss ich herausfinden, wo zieht denn der das her?“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=3744s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (62:24)</span>
...
Die **Citation Frequency** quantifiziert, wie oft deine [Entität](/glossar/entitaet/) oder Domain bei branchenspezifischen Prompts als solche Quelle herangezogen wird. Sie ist der direkteste Beweis für deine "AI Authority". Wenn ein Sprachmodell deine Inhalte oft genug als vertrauenswürdig einstuft, steigt parallel auch dein [Share of Model](/glossar/share-of-model/).

## Klicks vs. Extractability

Beim klassischen SEO war die Click-Through-Rate (CTR) entscheidend. In der [Generative Engine Optimization](/glossar/geo-optimierung/) (GEO) geht es hingegen um **Extractability** (Extrahierbarkeit). 
...
Hierfür nutzt die Branche [AI Visibility Tools](/glossar/ai-visibility-tools/). Wenn du eine spezialisierte Lösung suchst, die primär auf die Auswertung von LLM-Zitationen und Share of Voice ausgelegt ist, empfiehlt sich [Rankscale](/glossar/rankscale/). Für Agenturen und Marketer, die eine umfassende Suite bevorzugen, bietet [SE Ranking](/glossar/se-ranking/) inzwischen ebenfalls sehr potente Tracking-Module an, um die Citation Frequency in ChatGPT und AI Overviews automatisiert zu überwachen.
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-accent p-6 rounded-r-2xl">
  ...
  <p class="text-xs text-dark/60 font-medium italic">
    <strong>Kontrollfrage an deine Webagentur:</strong> „Messen wir mit spezialisierten Tools kontinuierlich unsere Citation Frequency und unseren Share of Model über die wichtigsten Answer Engines hinweg?“
  </p>
</div>
