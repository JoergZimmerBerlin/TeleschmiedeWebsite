...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      ...
      <a href="https://www.youtube.com/watch?v=pJFZzv5LEvk&t=2364s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer Folge 5 (39:24)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <p class="text-neutral-700 text-sm leading-relaxed mb-4">
    Wenn dir eine Agentur anbietet, deine Website „fit für KI-Suche“ zu machen, lass dir nicht einfach neue Blogtexte verkaufen. In 8 von 10 Audits sehe ich, dass die Agentur noch nicht einmal weiß, ob der eigene Webserver KI-Bots wie GPTBot oder PerplexityBot blockiert oder ob RAG-Crawler durch clientseitiges JavaScript ausgesperrt werden. Eine echte GEO-Agentur fängt immer am Server und an den strukturierten Entitäten an – nicht im WordPress-Editor.
  </p>
  <div class="bg-white/80 rounded-xl p-4 border border-lime-accent/40">
    <strong class="text-xs font-bold text-neutral-800 uppercase tracking-wide block mb-1">Deine Kontrollfrage an die GEO-Agentur:</strong>
    <p class="text-xs text-neutral-700 m-0 italic">
      „Mit welchen spezialisierten Monitoring-Tools tracken Sie unseren AI Share of Voice über ChatGPT, Perplexity und Google AI Overviews hinweg, und welche serverseitigen Datenendpunkte (z.B. llms.txt) richten Sie für uns ein?“
    </p>
  </div>
</div>
...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md">
  ...
  <p class="text-gray-300 text-sm mb-4 leading-relaxed">
    Kopiere diesen Prompt direkt in deinen KI-Coding-Assistenten (Cursor, Claude Code, Antigravity, ChatGPT), um für Kunden-Websites einen fehlerfreien, universellen Schema-Markup-Graphen für GEO und Rich Results zu generieren:
  </p>
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    <p class="text-lime-accent font-bold mb-1"># Prompt: Universellen Schema-Markup-Graphen für Kunden-Domain erstellen</p>
    <p><strong>Rolle:</strong> Du bist ein hochspezialisierter Technical SEO & Semantic Web Architect.</p>
    <p><strong>Aufgabe:</strong> Analysiere die Kunden-Website und erstelle einen vernetzten Schema.org JSON-LD Graphen (@graph) für die Root-Page und Unterseiten.</p>
    <p><strong>Anforderungen:</strong></p>
    <ul class="list-disc pl-4 space-y-1 text-gray-300">
      <li>Verknüpfe <code>Organization</code> bzw. <code>ProfessionalService</code> mit einer eindeutigen Entity-ID (z. B. <code>https://domain.de/#organization</code>).</li>
      <li>Erstelle die Entität <code>Person</code> für den Gründer/Geschäftsführer mit <code>sameAs</code>-Profilen (LinkedIn, Wikipedia, Wikidata, Campixx).</li>
      <li>Definiere <code>knowsAbout</code>-Entitäten mit passenden Wikidata-URIs für die Kernkompetenzen.</li>
      <li>Binde <code>WebSite</code>, <code>WebPage</code> und eine lückenlose <code>BreadcrumbList</code> in den gleichen Graphen ein.</li>
      <li>Stelle sicher, dass Trailing Slashes in allen internen URLs konsistent vorhanden sind.</li>
    </ul>
    <p class="pt-1"><strong>Output:</strong> Liefere das fertige JSON-LD Script inklusive Test-Anweisung für den Google Rich Results Test.</p>
  </div>
</div>
