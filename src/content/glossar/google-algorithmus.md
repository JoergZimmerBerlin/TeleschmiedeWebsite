...
faqs:
  - question: 'Wie funktioniert der Google Algorithmus im Jahr 2026?'
    answer: 'Er arbeitet als hochkomplexer RAG-Retriever. Er durchsucht den Index nach E-E-A-T-starken, vertrauenswürdigen "Chunks", um sie an große Sprachmodelle (LLMs) zu übergeben. Ohne Information Gain und saubere technische Struktur (strukturierte Daten) fällst du durch den Filter.'
  - question: 'Was bringen klassische Rankingfaktoren heute noch?'
    answer: 'Das Fundament bleibt: Technische Sauberkeit, Core Web Vitals und Backlinks als Trust-Signale. Aber der Fokus liegt auf Suchintention und Entitäten-Vertrauen. Eine starke Marke und tiefe "Topical Authority" schlagen Keyword-Optimierung um Längen.'
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Wie gesagt, hier diese ganzen Dinge gerne  durchgucken. Ich bin ja auch zwanzig Jahre im Game, früher war das anders, da war Google  so aggressiv, die haben dir alles gecrawlt, die wollten unbedingt jedes kleinste, sie wollten  das ganze Internet runterladen, das war ja so die Idee des Algorithmus dahinter, sie wollten auf  jeden Fall das Internet komplett tief ausleuchten.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=tD7cXuVcRPA&t=5361s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Never Code Alone (89:21)</span>
