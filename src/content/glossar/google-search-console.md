...
faqs:
  - question: 'Zeigt die GSC spezielle Metriken für AI Overviews (RAG) an?'
    answer: 'Ja, seit Juni 2026 gibt es im Leistungsbericht der GSC einen dedizierten Tab für Generative AI. Dieser zeigt Impressionen deiner URLs in AI Overviews und AI Mode an. Allerdings fehlen bisher harte Klickzahlen (CTRs) – es ist eher ein Diagnose-Radar als ein fertiges Dashboard.'
...
## Die Search Console im Zeitalter der KI (Update August 2026)

Lass uns ehrlich sein: Lange Zeit war Google eine Blackbox, wenn es um KI-Daten ging. Aber im Juni 2026 hat sich das radikal geändert. Google hat die **Generative AI Performance Reports** nativ im Leistungsbericht der Search Console ausgerollt. 

Wir haben jetzt einen dedizierten "Generative AI"-Tab neben den klassischen Such- und Discover-Berichten. Hier können wir filtern, wie oft unsere URLs in *AI Overviews*, im *AI Mode* oder in generativen KI-Features im Discover-Feed als Quelle zitiert werden.

**Aber Vorsicht – kenne die Limits:**
Das Dashboard liefert bisher (Stand August 2026) **ausschließlich Impressionen**. Keine Klickzahlen (Clicks) und keine Klickrate (CTR). Es ist ein reines Diagnose-Radar. Du siehst, *dass* Google dich für RAG-Antworten in Erwägung zieht, aber du siehst nicht, ob der Nutzer auch auf den Zitierungs-Link klickt. Hinzu kommen gelegentliche Logging-Anomalien (wie der kurzzeitige Einbruch Mitte August 2026), bei denen die Impressionen künstlich fallen, ohne dass es an deiner Sichtbarkeit lag.

### Vergleich: Klassische Suche vs. Generative AI Report

| Metrik / Feature | Klassischer Leistungsbericht | Generative AI Report (ab Mitte 2026) |
| :--- | :--- | :--- |
| **Klicks & CTR** | Vollständig sichtbar | Nicht vorhanden (Nur Impressionen) |
| **Filter-Optionen** | Suchanfragen, Seiten, Länder | Seiten, Länder, Endgeräte, Datum |
| **Zweck** | Messung echten Traffics | Diagnose von Zitationen & Marken-Sichtbarkeit |

Wenn Google immer mehr AI Overviews ausspielt, siehst du den Impact indirekt: Deine Impressionen für ein Keyword im klassischen Bericht bleiben extrem hoch, aber deine Klickrate rauscht in den Keller, weil die KI dem Nutzer die Antwort liefert ([Zero-Click-Searches](/glossar/zero-click-content/)). 
...
Als das "Generative AI" Dashboard im Juni 2026 aufpoppte, herrschte bei vielen meiner Agentur-Kunden Euphorie. "Endlich sehen wir, ob ChatGPT uns zitiert!" Falsch, wir sehen nur Google. Ein großer SaaS-Kunde von mir freute sich über rasant steigende AI-Impressionen, ignorierte aber zeitgleich die steigenden 404-Fehler im normalen Indexierungsbericht. 

Das ist der klassische Tunnelblick. Die harten organischen Rankings basieren auf sauberer Technik. Als wir die Server-Architektur bereinigten, die [Core Web Vitals](/glossar/core-web-vitals/) reparierten und die [Crawling vs Indexing](/glossar/crawling-vs-indexing/) Blockaden lösten, stiegen nicht nur die regulären Klicks, sondern die KI begann auch, präziser auf die Grounding-Seiten zu verlinken. Die Lektion? Die KI zitiert dich nur, wenn dein technisches SEO-Fundament im klassischen Index fehlerfrei ist.
...
Richte deine Dashboards auf fallende CTRs und das neue Generative AI Radar aus. Wer seine First-Party-Daten aus der GSC kennt, hat das Fundament gelegt. Wer die Basics ignoriert, dem hilft auch der beste KI-Hype nicht.
