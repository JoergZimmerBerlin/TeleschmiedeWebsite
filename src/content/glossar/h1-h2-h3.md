...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md relative not-prose">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <p><strong>2. Defensive & konfliktfreie Integration:</strong> Überschreibe NIEMALS funktionierende Core-Dateien oder Templates. Binde neue Logik defensiv und modular über vorhandene Erweiterungspunkte ein. Beachte dabei: Stelle sicher, dass jede gerenderte Route genau ein einziges <h1>-Tag besitzt (weder null noch mehrere H1-Tags); Prüfe auf verbotene Hierarchiesprünge (z. B. H1 direkt gefolgt von H3, oder H2 direkt gefolgt von H4); Trenne CSS-Klassen strikt von HTML-Tags: Wenn ein Text visuell angepasst werden soll, nutze Styling-Klassen, aber missbrauche keine semantischen Überschriften-Tags.</p>
