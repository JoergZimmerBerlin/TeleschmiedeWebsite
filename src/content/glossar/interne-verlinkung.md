...
date: "2026-03-10"
image: "/src/assets/images/glossar/interne-verlinkung-netz-de.png"
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  <p class="mb-0 text-sm">Ordne deine Inhalte in Themen-Clustern (Silos) an. Verlinke innerhalb eines Themas (z.B. "Google Ads") so tief und oft wie möglich miteinander. Vermeide es aber, ohne triftigen inhaltlichen Grund kreuz und quer von "Hundefutter" zu "Cloud-Software" zu verlinken. Das verwässert die semantische Relevanz deines Clusters.</p>
</div>
