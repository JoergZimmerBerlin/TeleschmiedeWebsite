...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md relative not-prose">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <p><strong>2. Defensive & konfliktfreie Integration:</strong> Überschreibe NIEMALS funktionierende Core-Dateien oder Templates. Binde neue Logik defensiv und modular über vorhandene Erweiterungspunkte ein. Beachte dabei: Scanne den Text nach stereotypen KI-Mustern („moderne Online-Welt“, „Schlüsselelement“, „wir analysieren nun“) und entferne sie restlos; Markiere Passagen, die reines Modell-Allgemeinwissen wiederholen; Schlage konkrete Einfügepunkte für eigene Fallbeispiele, Messwerte und Kontrollfragen vor.</p>
