...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Im Index? Sitemap einreichen ist der erste  Schritt bei jeder Domain, und Google Search Console anlegen ist auch Pflichtprogramm.  Wenn Leute in meine Sprechstunde kommen und noch nie von der Google Search Console gehört  haben, dann weiß ich ungefähr, dass die keine Kontrolle über ihr Asset haben, keine Kontrolle  über die Sichtbarkeit, brauchten es vielleicht nicht, aber irgendjemand hat es sträflich  vernachlässigt, das Ding anzulegen. Wie gesagt,.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=tD7cXuVcRPA&t=4624s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Never Code Alone (77:04)</span>
