...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Wie kannst du die Effektivität deiner SEO-Aktivitäten messen und den Return on Investment (ROI) bestimmen? Hier sind einige Schritte, die du unternehmen kannst: [...] Die Messung des ROI von SEO erfordert eine Kombination aus Datenanalyse und strategischer Auswertung, um fundierte Entscheidungen für deine zukünftigen SEO-Aktivitäten zu treffen.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.linkedin.com/feed/update/urn:li:activity:7099034791156543488" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <div class="pt-3 border-t border-lime-accent/20">
    <p class="text-xs text-dark/70 font-medium italic mb-0">
      <strong>Kontrollfrage an deine Webagentur:</strong> „Erfassen wir in unserem monatlichen Reporting bereits den AI Share of Voice und unsere Zitationsrate in Perplexity und ChatGPT?“
    </p>
  </div>
</div>
...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md">
  ...
  <p class="text-gray-300 text-sm mb-4 leading-relaxed">
    Kopiere diesen Prompt direkt in deinen KI-Coding-Assistenten, um automatisierte Prompt-Testing-Skripte für dein KI-Monitoring zu etablieren:
  </p>
