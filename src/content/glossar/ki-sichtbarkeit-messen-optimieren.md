...
key_takeaways:
  - "KI-Sichtbarkeit ist die neue Währung im SEO – wer nicht in den LLM-Antworten stattfindet, verliert Marktanteile."
...
<div class="my-8 bg-lime-accent/10 border-l-4 border-lime-600 p-6 rounded-r-lg">
  ...
  <p class="italic text-dark mb-0">"Rankings sind Vanity-Metriken. In der KI-Suche zählt nur noch Relevanz und Empfehlung. Wer nicht in der Antwort steht, hat für den Nutzer nicht stattgefunden. Punkt."</p>
</div>
