...
faqs:
  - question: "Was unterscheidet KI-Sichtbarkeit von klassischer SEO-Sichtbarkeit?"
    answer: "Klassische SEO-Sichtbarkeit misst Positionen in den zehn blauen Links einer Google-Ergebnisseite, um Website-Traffic zu erzeugen. KI-Sichtbarkeit bewertet hingegen, ob und wie eine Marke innerhalb eines direkt generierten Chat-Antworttextes als führende Expertenquelle genannt und verlinkt wird."
  - question: "Wie wird die KI-Sichtbarkeit in der Praxis gemessen?"
    answer: "Über den sogenannten Share of Model (SoM) und die Zitationsfrequenz (Citation Rate). Hierbei wird ein vordefiniertes Set geschäftsrelevanter Kundenprompts regelmäßig automatisiert an verschiedene Sprachmodelle gesendet und statistisch ausgewertet."
  - question: "Warum sinkt mein Website-Traffic trotz guter Sichtbarkeit in KIs?"
    answer: "Durch den Zero-Click-Trend erhalten Nutzer ihre Antworten unmittelbar im KI-Interface, ohne die Quell-Website zu besuchen. Die wirtschaftliche Konvertierung verlagert sich von Seitenaufrufen hin zu direkter Markenbekanntheit und vorbereiteten Kaufentscheidungen."
  - question: "Welche Rolle spielt Content-Qualität für die Zitationsrate?"
    answer: "Sprachmodelle filtern redundante Zusammenfassungen rigoros heraus. Nur Inhalte mit echtem 'Information Gain' – originären Datenpunkten, Studien, Fallbeispielen und klarer semantischer Struktur – werden von neuronalen Netzen als Primärzitat ausgewählt."
---

**KI-Sichtbarkeit** (im internationalen Fachjargon als AI Search Visibility oder Generative Engine Optimization / [GEO](/glossar/geo/) bezeichnet) beschreibt den Grad der Präsenz, Autorität und Zitationshäufigkeit einer Marke, eines Produkts oder einer Expertenperson innerhalb der synthetisierten Antworten generativer Sprachmodelle (wie ChatGPT, Perplexity, Claude und Google Gemini AI Overviews).
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Und eine AI ist ja in dem Sinne eine Generation, ja immer von Inhalten und auf einer gewissen Basis variieren die ja immer so ein bisschen.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=pJFZzv5LEvk&t=772s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer Folge 5 (12:52)</span>
...
Der [Share of Model](/glossar/share-of-model/) ist das generative Pendant zum traditionellen Share of Voice. Er misst, bei wie vielen Durchläufen eines definierten Fragenkatalogs (dem Golden Set an [Promptsets](/glossar/promptset/)) die eigene Marke im Vergleich zu Wettbewerbern genannt wird. Ein SoM von 40 % bedeutet, dass vier von zehn KI-Antworten das eigene Unternehmen empfehlen.

### 2. Citation Frequency (Zitationsrate)
Diese Metrik erfasst, wie häufig die URLs der eigenen Domain in den Fußnoten oder Quellverweisen der KI-Antwort aktiv verlinkt werden. Eine hohe Zitationsfrequenz ist das härteste Signal für informationelle Exzellenz und [Topical Authority](/glossar/topical-authority/).
...
| Kriterium | Traditionelle SEO-Sichtbarkeit | Generative KI-Sichtbarkeit (GEO) |
| :--- | :--- | :--- |
| **Primäres Ziel** | Klicks & organische Session-Zahlen | Zitationen, Mentions & Markenautorität |
