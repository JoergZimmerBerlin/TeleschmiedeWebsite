...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Agenturen oder Webagenturen und machen einen Relounge und und schneiden erstmal komplett dieses vorhandene Webg. Äh, das ist ja äh und dann vergessen sie noch die die Weiterleitung einzurichten und und äh ich kann dir ich kann dir wirklich nicht sagen, warum das in den letzten 20 Jahren nicht als Standard etabliert wurde, dass du, wenn du wenn du ein.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=dVGOMAVUNQk&t=676s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube SEOPresso (11:16)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <p class="text-dark/80 text-sm leading-relaxed mb-4">
    Konzentriere dich bei deinen Offpage-Maßnahmen auf verlinkungswürdige 'Linkable Assets'. Veröffentliche originäre Studien mit echten Branchenkennzahlen oder nützliche Online-Rechner. Journalisten und Fachredakteure zitieren Primärquellen freiwillig – das liefert organische Backlinks und unbezahlbare Co-Occurrence im semantischen Vektorraum der KIs.
  </p>
  <div class="pt-3 border-t border-lime-accent/20">
    <p class="text-xs text-dark/70 font-medium italic mb-0">
      <strong>Kontrollfrage an deine Webagentur:</strong> „Bauen wir Backlinks noch über veraltete Mietnetzwerke auf oder investieren wir in echte Digital-PR mit zitierfähigen Primärdaten?“
    </p>
  </div>
</div>
