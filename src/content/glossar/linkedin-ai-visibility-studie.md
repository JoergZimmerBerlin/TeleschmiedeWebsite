...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <div class="pt-3 border-t border-lime-accent/20">
    <p class="text-xs text-dark/70 font-medium italic mb-0">
      <strong>Kontrollfrage an deine Webagentur:</strong> „Nutzen unsere Führungskräfte und Experten bereits LinkedIn-Fachartikel mit originären Daten, um unsere Marken-Zitationen in LLMs aktiv zu steigern?“
    </p>
  </div>
</div>
