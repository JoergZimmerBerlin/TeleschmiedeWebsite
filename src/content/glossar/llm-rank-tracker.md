...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Dass ich anfangen kann, meinen Bildschirm zu  teilen. Okay, guck mal, kommt das an hier? Ja, ist auch von der Schriftgröße groß genug, würde  ich sagen. Okay, dann fange ich mal an. Ich habe deine Domain hier in mehrere Tools reingeladen,  wir fangen mal an, wir gucken erst mal, ich nehme gern Sistrix, das ist ein bezahltes SEO-Tool,  das kann dir einen schönen Überblick liefern,.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=tD7cXuVcRPA&t=1471s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Never Code Alone (24:31)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <p class="text-dark/80 text-sm leading-relaxed mb-4">
    Glaube niemals einer Agentur, die behauptet: „Wir tracken eure KI-Sichtbarkeit bereits manuell in ChatGPT.“ Wenn ein Mitarbeiter ab und zu drei Prompts in den Browser tippt, hat das null statistische Relevanz. Sprachmodelle sind stochastisch – je nach Tageszeit, Temperatur und Kontext variieren die Antworten. Ohne ein automatisiertes Multi-Prompt-Tracking über mindestens 10 bis 15 Engines hinweg (wie mit Rankscale) triffst du Budget-Entscheidungen auf Basis von Zufallstreffern.
  </p>
  <div class="pt-3 border-t border-lime-accent/20">
    <p class="text-xs text-dark/70 font-medium italic mb-0">
      <strong>Kontrollfrage an deine Webagentur:</strong> „Welche spezialisierte AI-Visibility-Software setzen Sie ein, um unsere wöchentliche Mention Rate und unser Sentiment über ChatGPT, Perplexity, Gemini und Claude automatisiert zu überwachen?“
    </p>
  </div>
</div>
