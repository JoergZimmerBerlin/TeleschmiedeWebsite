...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <ol class="list-decimal pl-4 space-y-1 text-gray-300">
      <li>Erfasse für jede Iteration Markennennung, Quellen-URLs, Position und Sentiment.</li>
      <li>Berechne den Volatilitäts-Score (Standardabweichung der Erwähnungsquote) und logge Citation Drift.</li>
      <li>Gleiche generierte Feature-Angaben mit einer Grounding-JSON-Datei ab, um Halluzinationen aufzudecken.</li>
      <li>Stelle sicher, dass alle internen URLs im Reporting strikt mit Trailing Slashes (/) validiert werden.</li>
    </ol>
  </div>
</div>
