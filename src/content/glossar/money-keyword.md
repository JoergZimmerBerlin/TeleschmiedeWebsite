...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md relative not-prose">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <p><strong>2. Defensive & konfliktfreie Integration:</strong> Überschreibe NIEMALS bestehende SEO-Plugins (Yoast, RankMath) oder vorhandene Schemas. Nutze Plugin-Hooks oder binde Entitäten modular in den bestehenden @graph-Container ein (keine Daten-Inseln, keine doppelten @id). Beachte dabei: Schritte & Validierung:; Validiere für jede transaktionale Leistungsseite die Vollständigkeit des Schemas (Service, Product, LocalBusiness oder Offer); Prüfe, ob Preise, Verfügbarkeit, Leistungsmerkmale und Garantien als maschinenlesbare Attribute hinterlegt sind (kein Verstecken im unstrukturierten Fließtext).</p>
