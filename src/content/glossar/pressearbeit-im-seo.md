...
sameAs: "https://www.wikidata.org/wiki/Q185077"
date: "2026-03-10"
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Ich denke, viele ähm sind ein bisschen verwöhnt worden und haben auch vergessen äh wie es früher mal war und also muss ich ja auch mal die andere Seite der Medaille anschauen, ne, von Google, ne?“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=581s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (09:41)</span>
...
<div class="my-8 bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose">
  ...
  <p class="text-neutral-700 text-sm leading-relaxed mb-4">
    Klassische PR-Agenturen verkaufen dir teure Pressemitteilungen, die über automatische Portale laufen und keinen einzigen echten Journalisten erreichen. Für Google und KI-Modelle ist das wertloser Spam. Frage deine PR-Abteilung stattdessen nach echten Primärdaten: Habt ihr interne Statistiken, Umfragen oder Auswertungen, die Journalisten als exklusive Story nutzen können? Nur solche Inhalte generieren echte Zitationen in Leitmedien.
  </p>
  <div class="bg-white/80 rounded-xl p-4 border border-lime-accent/40 text-xs text-neutral-800 space-y-2">
    <p class="font-bold text-lime-900 mb-1">🔍 Schneller Check in deiner Medien-Präsenz:</p>
    <p class="mb-1">1. Prüfe in <strong>SE Ranking</strong> oder Google Alerts, wie viele redaktionelle Erwähnungen deine Marke im letzten Quartal erzielt hat.</p>
    <p class="mb-1">2. Kontrolliere, ob die Autoren deiner Fachbeiträge per Schema.org (<code>sameAs</code>) mit externen Veröffentlichungen verknüpft sind.</p>
    <p class="mb-0 font-semibold text-lime-950"><strong>Kontrollfrage an deine PR-Agentur:</strong> <em>„Basiert unsere PR-Strategie auf exklusiven Primärdaten mit echtem Information Gain, und überwachen wir aktiv die Aufnahme unserer Brand Mentions in RAG-Pipelines?“</em></p>
  </div>
</div>
...
<div class="my-10 bg-dark text-white p-8 rounded-3xl border border-white/10 text-center shadow-md not-prose">
  ...
  <a href="https://www.linkedin.com/feed/update/urn:li:activity:6973254524262088705" target="_blank" rel="noopener noreferrer" class="btn-primary">
