...
sameAs: "https://www.wikidata.org/wiki/Q80776"
date: "2026-07-18"
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Das kommt immer auf den Einzelfall an, das hatte  ich ja im Vorfeld gesagt, jeder kommt mit einem unterschiedlichen Setup, nicht jeder kommt mit  einer tausend Unterseiten großen Domain daher, nicht jeder kommt mit technischem Verständnis  daher, manche wollen einfach nur Leads haben und haben fünf bis zehn Unterseiten, und  dann muss man trotzdem erst mal gucken, bist du indexiert, hast du eine Unterseite für  dein Hauptkeyword oder deine Hauptkeywörter,.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=tD7cXuVcRPA&t=7625s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Never Code Alone (127:05)</span>
