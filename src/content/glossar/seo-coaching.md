...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Persönlich sind oder wo die dann sagen, auch komm, den schreibe ich jetzt mal an. Na, die Leute brauchen natürlich immer ein bisschen. Und was ich was ich aber auch da gelernt habe, äh Infotainment ist schön, bringt aber keinen Umsatz. Mm. Ja, wenn du nicht sagst, was du anbietest, dich keiner. Und das muss ich halt auch lernen, dass man auch mal richtig sagen.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=1270s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (21:10)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <p class="text-dark font-semibold text-base mb-3">
    Trainiere dein Team direkt am Live-System statt an generischen Folien.
  </p>
  <p class="text-neutral-700 text-sm mb-0">
    <strong>Kontrollfrage an deine Inhouse-Mannschaft:</strong> „Kann unser Team eine fehlerhafte <code>robots.txt</code>, einen defekten RFC-8288-Header oder fehlendes JSON-LD-Markup ohne externe Agenturhilfe innerhalb von 15 Minuten selbst diagnostizieren und im Code beheben?“
  </p>
</div>
