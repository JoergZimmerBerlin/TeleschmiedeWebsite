...
sameAs: "https://www.wikidata.org/wiki/Q1479842"
date: "2026-08-20"
...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Verschwendet meist auch nur Energie, weil da musst du meistens musst du noch den den Paid Manager äh äh bezahlen, du musst dein Budget vorhalten, du musst äh dir auch ein Tracking einrichten. Ähm das ist schon ein bisschen Investition verbunden, ne? Und ähm aber das ist für ein Staat, für jemanden, der ein neues Geschäft hat oder eine Aktion fährt oder der.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=1781s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (29:41)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  ...
  <p class="text-dark font-semibold text-base mb-3">
    Beurteile dein Wachstum niemals anhand absoluter Klickzahlen ohne relativen Share of Voice.
  </p>
  <p class="text-neutral-700 text-sm mb-0">
    <strong>Kontrollfrage an deine Marketingabteilung:</strong> „Wächst unser relativer Share of Voice im Vergleich zum Gesamtsuchvolumen unserer direkten Wettbewerber – oder freuen wir uns über zehn Prozent mehr Klicks, während der Markt um dreißig Prozent gewachsen ist?“
  </p>
</div>
...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md">
  ...
  <p class="text-gray-300 text-sm mb-4 leading-relaxed">
    Kopiere diesen Prompt direkt in deinen KI-Coding-Assistenten, um eine automatisierte Berechnung des organischen Share of Voice (SOV) zu implementieren:
  </p>
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    <p class="text-lime-accent font-bold mb-1"># Prompt: Automatisierte Share-of-Voice-Berechnung</p>
    <p><strong>Rolle:</strong> Du bist ein SEO Data Analyst und Python-Entwickler.</p>
    <p><strong>Aufgabe:</strong> Entwickle ein Skript zur Verarbeitung von SERP-Ranking-Exporten (z. B. aus SE Ranking oder Sistrix) zur Ermittlung des relativen SOV pro Marke.</p>
    <p><strong>Schritte & Validierung:</strong></p>
    <p>1. Importiere CSV-Dateien mit den Spalten <code>Keyword</code>, <code>Search_Volume</code>, <code>Domain</code> und <code>Position</code>.</p>
    <p>2. Ordne jeder Position eine empirische CTR zu (Position 1: 32%, 2: 17%, 3: 10%, 4: 6%, 5: 4%, 6-10: 2%).</p>
    <p>3. Berechne die geschätzten Klicks pro Domain und teile sie durch das Gesamtklickvolumen des Keyword-Sets.</p>
    <p>4. Gib die Ergebnisse tabellarisch als Markdown und als JSON-Export für BI-Dashboards aus.</p>
  </div>
</div>
