...
sameAs: "https://www.wikidata.org/wiki/Q109783499"
date: "2026-03-19"
...
<div class="my-8 bg-dark text-white p-6 rounded-2xl border-l-4 border-lime-accent shadow-md relative not-prose">
  ...
  <div class="bg-black/60 p-4 rounded-xl border border-white/10 text-xs font-mono text-gray-200 overflow-x-auto space-y-2">
    ...
    <p><strong>2. Defensive & konfliktfreie Integration:</strong> Überschreibe NIEMALS bestehende Webserver-Konfigurationen. Ergänze Direktiven modular (.htaccess / Nginx / Vercel Headers). Halte Link-Header strikt nach RFC 8288 ohne Anführungszeichen in den spitzen Klammern. Beachte dabei: Schritte & Validierung:; Analysiere das URL-Matching und bilde alte Pfade 1:1 auf die passendsten neuen URLs ab (keine pauschalen Startseiten-Redirects); Generiere die Server-Konfigurationsdatei (Nginx map-Block oder Apache RewriteRule) mit striktem Trailing Slash am Ende jedes Pfades.</p>
