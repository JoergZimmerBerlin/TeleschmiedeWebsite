...
<figure class="my-8 bg-neutral-50 border border-neutral-200 p-6 md:p-8 rounded-2xl shadow-sm">
  ...
  <blockquote class="text-base md:text-lg text-dark leading-relaxed italic border-l-4 border-lime-accent pl-4 my-4 font-normal">
    „Webseiten Webseiten sind komplexe Konstrukte, die selbst die einfachste WordPressseite äh kann dir auch sowas machen. auch heute immer noch diese Feed und was sie da alles produzieren und das Schönste ist, ich installiere ein SEO Plugin im WordPress, ja, oder ich also die die Kunden und dann vergessen sie das zu konfigurieren und plötzlich ist äh jeder Tag äh jede produziert.“
  </blockquote>
  <figcaption class="mt-4 pt-3 border-t border-neutral-200/60 flex flex-wrap items-center justify-between gap-2 text-xs text-neutral-500">
    <div class="flex flex-wrap items-center gap-x-2 gap-y-1">
      <span>Experten-Zitat • <cite class="not-italic font-semibold text-neutral-700">Jörg Zimmer</cite></span>
      <span class="text-neutral-300 hidden sm:inline">•</span>
      <a href="https://www.youtube.com/watch?v=ZIFCXUXypSc&t=3159s" target="_blank" rel="noopener noreferrer" class="text-neutral-600 hover:text-dark underline inline-flex items-center gap-1">
        <span>Quelle: YouTube Talk Antonio Blago & Jörg Zimmer (52:39)</span>
...
<div class="bg-lime-accent/15 rounded-2xl border border-lime-accent/30 p-6 shadow-sm not-prose my-8">
  <div class="flex items-center gap-2 mb-3">
    ...
    <span class="text-xs font-semibold text-neutral-600">WordPress-Performance & Caching</span>
  </div>
...
![WordPress SEO Infografik: Markdown, Core Web Vitals und moderne KI-Architektur](../../assets/images/glossar/themes/glossar-theme-technical.webp)
